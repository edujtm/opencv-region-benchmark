...
int main(int argc, char* argv[]) {
    ...
    cv::Point2i top_left { std::get<0>(config.top_left), std::get<1>(config.top_left) };
    cv::Point2i lower_right { std::get<0>(config.lower_right), std::get<1>(config.lower_right) };
